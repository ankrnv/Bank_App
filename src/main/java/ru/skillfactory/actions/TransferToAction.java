...
public class TransferToAction implements UserAction {
    ...
    /**
     * Перевести средства - также общаемся в этом методе с пользователем и передаём информацию,
     * так как операция важная, ещё раз заставляем вводить пароль/логин и передаём информацию
     * в BankService
     *
